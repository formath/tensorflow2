...
def remote_variable_op(shape, name="RemoteVariable"):
  """Create a remote variable Operation.

  Args:
    shape: The shape of the tensor generated by this op.
    name: optional name to use for the variable op.

  Returns:
    A tensor.
  """
  return gen_state_ops.remote_variable(
      shape=shape,
      dtype=dtype,
      name=name)

def remote_sparse_variable_op(keys, embedding_size, name="RemoteVariable"):
  """Create a remote variable Operation.
  ...
  Returns:
    A tensor.
  """
  return gen_state_ops.remote_sparse_variable(
      keys=keys,
